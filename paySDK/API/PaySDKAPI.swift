...
enum PaySDKAPI {
    ...
    var method: HTTPMethod {
        switch self {
        case .withdrawToPublicKey, .withdrawToAccount, .withdrawToAddressId, .withdrawToWalletId, .hideAsset, .transfer, .validatePin, .showAsset, .addAddress:
            return .post
